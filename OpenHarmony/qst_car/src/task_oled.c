...
static void OledShowIrStatus(WifiIotGpioValue left, WifiIotGpioValue right)
{
    ...
    SSD1306_ShowStr(0, 3, leftLine, 8);
    SSD1306_ShowStr(0, 5, rightLine, 8);
}
